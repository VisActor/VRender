...
import { createArea, CustomPath2D, type IAreaGraphicAttribute } from '../../src/index';
...
function fixture(attrs: IAreaGraphicAttribute, dirty = false) {
  ...
  const stage = createBrowserStage({ canvas, width: 140, height: 80, dpr: 1, disableDirtyBounds: !dirty });
