...
- The GitHub Release body should use this file plus the 1.1.0 release reports as the reviewed source.
- Package `CHANGELOG.md` files are generated by the Rush release workflow and should not be manually edited.
- Site changelog files under `docs/assets/changelog` are generated after the GitHub Release is published by `.github/workflows/release-changelog.yml`.
- If the final release commit changes after this check, refresh the release reports before publishing.
