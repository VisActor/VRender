...
Page({
  ...
  init(name) {
    tt.createSelectorQuery()
      .select(`#draw`)
      .boundingClientRect(async domref => {
        if (!domref) {
        ...
        await vglobal.setEnv('tt', { domref, force: true, canvasIdLists, freeCanvasIdx: 0 });
        ...
        //   stage.render();
        // }, 1000);
        // const canvas = vglobal.getElementById('draw');
        // const ctx = canvas.getContext('2d');
        // ctx.fillStyle = 'red';
        // ctx.fillRect(0, 0, 1000, 1000);
        stage.render();
        console.log(stage, 'aaa', vglobal.getElementById('draw'));
        // ctx.draw();
        // console.log('abcdefg3');
      })
      .exec();
  },
  bindEvent(event) {
