...
| ID | 任务 | 状态 | 进度记录 |
| --- | --- | --- | --- |
| BS-P0-002 | core graphic/common heavy path 内容瘦身审计 | in-progress | 已完成四片 dead-source 清理：累计减少 core source 49,843 raw / 11,059 gzip；latest 删除未接口化的 graphic-service path proxy bounds helper |
