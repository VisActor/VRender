...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| BS-P0-001 | 建立 VRender 自身 package/module size ledger | 全包 / build output | 当前只有 VChart 外部 bundle 视角，缺少 VRender 自身 `src/es/cjs` 文件级内容大小基线 | `packages/*/src`、`packages/*/package.json`、构建产物 | VRender package content -> publish/build output | 不改变行为 | High | Low | P0 | 文件级 raw/gzip 统计；`rush build` 或现有产物；记录到 baseline | 不需要 | ready-for-implementation |
