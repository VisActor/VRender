...
export const page = () => {
  ...
  import('https://tosv.byted.org/obj/dpvis/bugserver-vrender/vtable-used-in-vrender-bugserver.js').then(async () => {
    ...
    const ListGrid = VTable.ListTable;
        ...
        },
        {
          ...
          fieldFormat: {
            ...
            set(rec, val) {
              ...
              rec.birthday = isNaN(Number(date.toString())) ? val : date;
            }
          },
          width: 100
        }
    ...
    const instance = new ListGrid(option);

    //设置表格数据
    instance.setRecords(generatePersonsDataSource(1));
    // instance.setScrollTop(100);
    // instance.selectCells([{start:{row:5,col:2},end:{row:6,col:5}}]);
  });
  return;
