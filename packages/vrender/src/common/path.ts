...
import { IContext2d, ILine } from '../interface';
import {
  CommandStrType,
  CommandType,
  IArcCurve,
...
import { cubicLength, cubicPointAt } from './bezier';
import { BoundsContext } from './bounds-context';
import { calcLineCache } from './curve';
import { addArcToBezierPath } from './morphing-utils';
...
import { bezier, segments } from './shape/arc';
...
export abstract class Curve implements ICurve<IPoint> {
  ...
  protected abstract calcProjLength(direction: Direction): number;
}

export class CubicBezierCurve extends Curve implements ICubicBezierCurve {
  type: number = ICurveTypeEnum.CubicBezierCurve;
  ...
  protected calcProjLength(direction: Direction): number {
...
export class QuadraticBezierCurve extends Curve implements IQuadraticBezierCurve {
  type: number = ICurveTypeEnum.QuadraticBezierCurve;
  declare readonly p0: IPoint;
  declare readonly p1: IPoint;
  declare readonly p2: IPoint;
...
export class ArcCurve extends Curve implements IArcCurve {
  type: number = ICurveTypeEnum.ArcCurve;
  declare readonly p0: IPoint;
  declare readonly p1: IPoint;
...
export class LineCurve extends Curve implements ILineCurve {
  type: number = ICurveTypeEnum.LineCurve;
  declare p0: IPoint;
  declare p1: IPoint;
...
export class EllipseCurve extends Curve implements IEllipseCurve {
  type: number = ICurveTypeEnum.EllipseCurve;
  declare p0: IPoint;
...
export class MoveCurve extends Curve implements IMoveCurve {
  type: number = ICurveTypeEnum.MoveCurve;
  declare p0: IPoint;
  declare p1: IPoint;
  constructor(p0: IPoint, p1: IPoint) {
    super();
...
export class CurveContext implements IPath2D {
  ...
  // linear
  protected addLinearCurve(x: number, y: number): LineCurve {
