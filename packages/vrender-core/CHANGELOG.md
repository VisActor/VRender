...
This log was last generated on Fri, 28 Aug 2026 07:45:05 GMT and should not be manually modified.

## 1.1.9
Fri, 28 Aug 2026 07:45:05 GMT

_Version update only_

## 1.1.8
Wed, 12 Aug 2026 07:23:35 GMT

_Version update only_

## 1.1.7
Sun, 02 Aug 2026 07:21:46 GMT

_Version update only_

## 1.1.6
Wed, 29 Jul 2026 11:52:34 GMT
...
## 1.1.3
Tue, 30 Jun 2026 09:31:30 GMT

_Version update only_

## 1.1.2
Mon, 29 Jun 2026 08:32:21 GMT

_Version update only_

## 1.1.1
Thu, 25 Jun 2026 02:44:21 GMT
...
## 1.0.36
Wed, 24 Dec 2025 06:30:43 GMT

_Version update only_

## 1.0.35
Mon, 22 Dec 2025 08:54:24 GMT

_Version update only_

## 1.0.34
Mon, 22 Dec 2025 08:29:50 GMT
...
- feat: polygin support customPath with render strategy
- feat: support afterClearScreen hooks
- feat: add animate interface
...
- fix: set finalAttribute when applyStateAttrs
...
- fix: incorrect result for TagPointsUpdate animation
...
- feat: graphic support clipConfig attribute
- feat: group support drawMode attribute
...
- fix: fix issue with image stroke style
- fix: issue where NAN appears during the text animation process, #1752
...
- fix: fix issue with metrics setter
...
- fix: fix the issue where the final text of the label increase count  animation is incorrect
