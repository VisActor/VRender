...
| BS-P0-006 | 建立图表 / 表格常规场景收益 gate | completed 2026-06-03 | 已记录 VRender source ledger、VChart line/pie/simple/full 代理场景样本、VTable table-only 补充口径和后续任务预估收益 |
