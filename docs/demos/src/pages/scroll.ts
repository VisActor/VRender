import { createStage, createRect, Rect, Circle, Group, container, createGroup } from '@visactor/vrender';
...
export const page = () => {
  ...
  group.addEventListener('wheel', e => {
    console.log(group);
    group.setAttributes({
      scrollX: (group.attribute.scrollX || 0) + e.deltaX,
      scrollY: (group.attribute.scrollY || 0) + e.deltaY
    });
  });
