# How to Reference VRender in the Project
...
After obtaining the VRender file from [cdn](./How_to_Get_VRender#cdn-%E8%8E%B7%E5%8F%96), it can be added to the `<script>` tag in the HTML file:
