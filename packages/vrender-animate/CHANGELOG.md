...
- Stabilize animation static-truth ownership and expose optional custom animation registers for basic, richtext, disappear, and story profiles while keeping the full register compatible.
